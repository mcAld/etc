    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4><i class="fa fa-book"></i> Assessment Centers</h4> 
          </div>
        </header>
      </div>
      <div id="left">
              ...
              <div class ="col-lg-12">
                <div class="box dark">
                  <header>
                    ...
                    <h5>List of All Assessment Centers</h5>
                    <div class ="pull-right col-sm-8 col-md-8" style ="padding:5px;">
                      <div class ="input-group">
                          <input type ="text" class ="form-control btn-rect input-sm" placeholder ="Search Here .">
                          <div class ="input-group-btn">
                            <button class ="btn btn-sm btn-metis-5 btn-rect" type ="submit"><i class ="fa fa-search"></i></button>
                          </div>
                          &nbsp;
                          <div class ="input-group-btn">
                            <a href="<?php echo base_url('index.php/home/new_ac') ?>">
                              <button class ="btn btn-sm btn-primary btn-rect "><i class ="fa fa-plus"> </i> &nbsp;Add New AC</button>
                            </a>
                          </div>
                          &nbsp;
                          <div class ="input-group-btn">
                            <a href="<?php echo base_url('index.php/home/new_assessor') ?>">
                              <button class ="btn btn-sm btn-primary btn-rect "><i class ="fa fa-plus"> </i> &nbsp;Add New Assessor</button>
                            </a>
                          </div>
                          &nbsp;
                          <div class ="input-group-btn">
                      ...
                      <div class ="table-responsive">
                          <table id ="verified-request" class ="table table-bordered table-striped table-hover">
                              ...
                              <tbody>
                                  <tr>
                                      <td>PTC - Carmen</td>
                                      <td>Poblacion, Carmen , Cebu</td>
                                      <td>Tailoring NC I</td>
                                      <td>John Paul Bareja</td>
                                      <td>09239382190</td>
                                      <td><a href =""><i class ="fa fa-times"></i></a> / <a href ="edit-ac.php"><span class ="glyphicon glyphicon-edit"></span></a></td>
                                  </tr> 
                              </tbody>
                          </table>
                      </div>
