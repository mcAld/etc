    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4><i class="fa fa-plus-circle"></i>  New Training Insitution</h4> 
          </div>
        </header>
      </div><!-- /#top -->
      <div id="left">
              ...
              <div class ="col-lg-12">
                 <div class="box dark">
                  <header>
                    ...
                    <h5>Add New Training Insitutions</h5>
                    <div class ="pull-right col-sm-6 col-md-6" style ="padding:5px;">
                      <div class ="input-group">
                          &nbsp;
                          <div class ="input-group-btn">
                            <a href="view-institutions.php">
                              <button class ="btn btn-sm btn-metis-3 btn-rect "> <i class ="fa fa-compass"></i>&nbsp; View Institutions</button>
                            </a>
                          </div>
                      </div>
                    </div>
