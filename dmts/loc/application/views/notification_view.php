...
<html lang="en">
  ...
  <body>
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4>
              <i class="fa fa-bell"></i>  Notifications</h4>
          </div><!-- /.main-bar -->
        </header>
          ...
          <div class="inner">
            <div class ="row">
              <div class ="col-lg-8">
                <div class="box">
                  <header>
                    <h5><i class="fa fa-bolt"></i>&nbsp; All Notifications</h5>
                  </header>
                  <div class="body" style ="height:400px!important; overflow:scroll;">
                    <?php 
                    	foreach($notification as $row){
                    ?>	
                    	<div class="alert alert-default alert-dismissable">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        <strong><?php echo $row->name ?></strong> <?php echo $row->notification_msg ?>
              ...
              <div class ="col-lg-4">
                <div class="box">
                  <header>
                    <a href="<?php echo base_url('index.php/home/certificate_request') ?>">
                        <h5> <i class="fa fa-certificate"></i>&nbsp;  Certificate Request</h5>
                    </a>
                  </header>
                  <div class="body" >
                    <table id ="certificate-request" class ="table table-condensed table-hover tablesorter table-striped">
                      <thead>
                          <tr>
                            <th ><a href ="#" title ="Click to Sort" style ="text-decoration:none;color:#748307;">Reference Number</a></th>
                            <th style ="text-align:center;"><a href ="#" title ="Click to Sort " style ="text-decoration:none;color:#748307;">Status</a></th>
                          </tr>
                      </thead>
                      <tbody style ="height:400px!important; overflow:scroll;">
                        <?php 
			                  	foreach($creq_sum as $row){
			                  ?>	
			                  	<tr>
			                  		<td><?php echo $row->cars ?></td>
			                  		<td class ="<?php echo $row->status ?>" style ="color:green"><i class ="fa fa-check btn btn-sm "> </i> <?php echo $row->status ?></td>
                     			</tr>
			                  <?PHP	
			                  	}
			                  ?>
    ...
    <script>
      $(function() {
        $("#certificate-request").tablesorter({debug: true});
      });
    </script>
    </body>
</html>