    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4><i class="fa fa-group"></i> Users List</h4> 
          </div>
        </header>
      </div>
      <div id="left">
                    ...
                    <div class ="pull-right col-sm-3 col-md-3" style ="padding:5px;">
                      <div class ="input-group">
                          ...
                          <div class ="input-group-btn">
                            <a href="<?php echo base_url('index.php/home/new_user') ?>">
                              <button class ="btn btn-sm btn-metis-3 btn-rect "><i class ="fa fa-plus"> </i> &nbsp;Add New User</button>
                            </a>
                          </div>
                        </div>
                      </div>
													    ...
													    ?>		
													        ...
													        <?php 
													        	echo "<td>".$row->user_name ."</td>";
																	...
																	?>
													        <td><a class="delete_user" data-id="<?php echo $row->tbl_num ?>" href=""><i class ="fa fa-times"></i></a> / <a class="edit_user" data-id="<?php echo $row->tbl_num ?>"  href=""><i class ="fa fa-edit"></i></a> </td>
													    	</tr> 
													    <?php	
													    	}
													    	?>
