    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4>
              <i class="fa fa-user"></i> Competency Assessors
            </h4> 
          </div><!-- /.main-bar -->
        </header>
              ...
              <div class ="col-lg-12">
                <div class="box dark">
                  <header>
                    ...
                    <h5>List of All Assessors</h5>
                    <div class ="pull-right col-sm-9 col-md-9" style ="padding:5px;">
                      <div class ="input-group">
                          ...
                          <table id ="verified-request" class ="table table-bordered table-striped table-hover">
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td>Male</td>
                                      <td>09239382190</td>
                                      <td><a href =""><i class ="fa fa-times"></i></a> / <a href ="edit-assessor.php"><span class ="glyphicon glyphicon-edit"></span></a></td>
                                  </tr> 
                              </tbody>
                          </table>
                      </div>
