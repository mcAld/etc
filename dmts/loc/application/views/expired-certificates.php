    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4>
              <i class="fa fa-calendar"></i> Expired Certificates</h4>
          </div><!-- /.main-bar -->
        </header>
        ...
        <ul id="menu" class="collapse">
          ...
          <li class="">
            ...
            <ul>
              ...
              <li class="">
                <a href="<?php echo base_url('index.php/home/view_users') ?> "><i class="fa fa-angle-right"></i>&nbsp; View User List</a>
              </li>
              <li class="">
                <a href="<?php echo base_url('index.php/home/new_user') ?>"><i class="fa fa-angle-right"></i>&nbsp; Create new User</a>
              </li>
            </ul>
          </li>
        </ul>
              ...
              <div class ="col-lg-12">
                <div class="box dark">
                  <header>
                    ...
                    <h5>List of All Expired Certificates</h5>
                  </header>
                  <div class="body">
                      <div class ="row">
                          <div class ="col-lg-12">
                              <div class ="table-responsive">
                                  <table id ="verified-request" class ="table table-bordered table-striped table-hover">
                                      ...
                                      <tbody>
                                          <tr>
                                              <td>12070202019296</td>
                                              <td>Garcia, Rosemarie S.</td>
                                              <td>09433544557</td>
                                              <td>Household Services NC II</td>
                                              <td>TESDA RTC VII</td>
                                              <td>10/09/2012</td>
                                              <td>01/24/2014</td>
                                          </tr> 
