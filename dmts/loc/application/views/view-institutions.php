              ...
              <div class ="col-lg-12">
                <div class="box dark">
                  <header>
                    ...
                    <h5>List of All Training Institutions</h5>
                    <div class ="pull-right col-sm-5 col-md-5" style ="padding:5px;">
                      <div class ="input-group">
                          ...
                          <div class ="input-group-btn">
                            <a href="<?php echo base_url('index.php/home/new_institution') ?>">
                              <button class ="btn btn-sm btn-primary btn-rect "><i class ="fa fa-plus"> </i> &nbsp;Add New Instituion</button>
                            </a>
                          </div>
                        </div>
                      </div>
                          ...
                          <table id ="verified-request" class ="table table-bordered table-striped table-hover">
                              ...
                              <tbody>
                                  <tr>
                                      ...
                                      <td><a href =""><i class ="fa fa-times"></i></a> / <a href ="<?php echo base_url('index.php/home/edit_institution') ?>"><span class ="glyphicon glyphicon-edit"></span></a></td>
                                  </tr> 
                              </tbody>
                          </table>
                      </div>
