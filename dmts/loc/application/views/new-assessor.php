    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4><i class="fa fa-user"></i>New Competency Assessor</h4> 
          </div><!-- /.main-bar -->
        </header>
      </div>
      <div id="left">
                     ...
                     <div class ="pull-right col-sm-6 col-md-6" style ="padding:5px;">
                      <div class ="input-group">
                          <div class ="input-group-btn">
                            <a href="<?php echo base_url('index.php/home/new_ac') ?>">
                              <button class ="btn btn-sm btn-primary btn-rect "> <i class ="fa fa-plus-circle"></i>&nbsp; Add Assessment Center</button>
                            </a>
                          </div>
                          &nbsp;
                          <div class ="input-group-btn">
