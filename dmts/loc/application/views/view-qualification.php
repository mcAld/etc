    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4><i class="fa fa-tags"></i> List of all Qualifications</h4> 
          </div>
        </header>
      </div>
      <div id="left">
              ...
              <div class ="col-lg-12">
                <div class="box dark">
                  <header>
                    ...
                    <h5>List of All Qualification</h5>
                    <div class ="pull-right col-sm-8 col-md-8" style ="padding:5px;">
                      <div class ="input-group">
                          ...
                          <div class ="input-group-btn">
                            <a href="<?php echo base_url('index.php/home/new_competency') ?>">
                              <button class ="btn btn-sm btn-primary btn-rect "><i class ="fa fa-plus"> </i> &nbsp;Add New Competency</button>
                            </a>
                          </div>
                        </div>
                      </div>
