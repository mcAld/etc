    ...
    <div id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h4><i class="fa fa-tags"></i>New Qualification Title</h4> 
          </div>
        </header>
      </div>
      <div id="left">
                    ...
                    <form role ="form">
                        <div class ="row">
                          <div class ="col-lg-12">
                            ...
                            <div class ="col-lg-6">
                              <div class ="form-group">
                                  <label>Qualification Competencies:</label>
                        ...
                        <div class ="row">
                            <div class ="col-lg-12">
                              ...
                              <div class ="col-lg-3">
                                  ...
                                  <div class ="input-group-btn ">
                                     <button class ="btn btn-sm btn-primary btn-rect " type ="reset"><i class ="fa fa-refresh"></i>&nbsp; Reset Filter Values</button>
                                  </div>
                              </div>
                            </div>
                        </div>
