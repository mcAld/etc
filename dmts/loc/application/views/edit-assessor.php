        ...
        <ul id="menu" class="collapse">
          ...
          <li class="active">
            ...
            <ul>
              ...
              <li class="active">
                <a href="edit-assessors.php ">
                  <i class="fa fa-angle-right"></i>&nbsp; Edit Assessor
                </a>
              </li>
              <li class="">
              ...
              <div class ="col-lg-12">
                <div class="box dark">
                  <header>
                    ...
                    <h5>New Assessor</h5>
                     <div class ="pull-right col-sm-2 col-md-2" style ="padding:5px;">
                      <div class ="input-group">
                        &nbsp;
                          ...
                          <div class ="col-lg-12">
                            ...
                            <div class ="col-lg-5 ">
                                ...
                                <div class ="form-group">
                                    ...
                                    <select class ="form-control">
                                        <option>-Choose a Assessment Center-</option>
                                        <option>Benedicto College</option>
